...
import { ChartLineUp, Target, RocketLaunch, Wallet, FlowArrow } from "@phosphor-icons/react";
...
const items = [
  ...
  { to: "/execution-missions", label: "Execute", icon: FlowArrow },
  { to: "/settlements", label: "Payout", icon: Wallet },
];

export default function MobileDock() {
  return <nav className="fixed inset-x-0 bottom-0 z-50 grid grid-cols-5 border-t border-gborder bg-bg/95 px-1 pb-[max(.5rem,env(safe-area-inset-bottom))] pt-2 backdrop-blur-xl lg:hidden">
