...
router.post('/discovery/candidates/:id/acquisition/response', ctrl.recordAcquisitionResponse);
router.post('/discovery/candidates/:id/acquisition/award-mission', ctrl.verifyAcquisitionAwardAndCreateMission);
