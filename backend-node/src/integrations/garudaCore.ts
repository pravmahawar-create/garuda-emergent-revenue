...
export const listContinuousRevenueAttempts = () => requestCore<unknown[]>('/api/discovery/attempts/status');
export const runContinuousRevenueAttemptCycle = () => requestCore<unknown>('/api/discovery/attempts/run', { method: 'POST' });
...
export const getProductionDelivery = (missionId: string) => requestCore<unknown | null>(`/api/discovery/execution-missions/${encodeURIComponent(missionId)}/production-delivery`);
export const recordProductionQuality = (missionId: string, payload: unknown) => requestCore<unknown>(`/api/discovery/execution-missions/${encodeURIComponent(missionId)}/production-delivery/quality`, { method: 'POST', headers: { 'content-type': 'application/json', 'x-garuda-founder-approved': 'true' }, body: JSON.stringify(payload) });
export const approveFinalDelivery = (missionId: string, payload: unknown) => requestCore<unknown>(`/api/discovery/execution-missions/${encodeURIComponent(missionId)}/production-delivery/final-approval`, { method: 'POST', headers: { 'content-type': 'application/json', 'x-garuda-founder-approved': 'true' }, body: JSON.stringify(payload) });
export const prepareProductionDeliveryHandoff = (missionId: string, payload: unknown) => requestCore<unknown>(`/api/discovery/execution-missions/${encodeURIComponent(missionId)}/production-delivery/handoff`, { method: 'POST', headers: { 'content-type': 'application/json', 'x-garuda-founder-approved': 'true' }, body: JSON.stringify(payload) });
